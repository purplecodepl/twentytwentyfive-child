<?php
/*
 * Title: Query Loop for Books
 * Slug: twentytwentyfive-child/template-query-loop-book
 * Categories: query
 ...
 */
?>
<!-- wp:query {"query":{"perPage":5,"pages":0,"offset":0,"postType":"book","order":"desc","orderBy":"date"},"pagination":{"type":"number"}} -->
